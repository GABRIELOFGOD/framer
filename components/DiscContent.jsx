      ...
      ref={ref}
        ...
        className='mx-auto flex md:flex-row flex-col-reverse box-border h-[600px]'>
            ...
            <div className='md:flex-1 disc w-full h-[350px] md:h-full'>
                <img className='scale-[1.5]' src={`${baseUrl}african-american-business-man-reading-news-talking-phone.jpg`} />
            </div>
        </motion.div>
        <motion.div
      ref={ref}
        ...
        className='mx-auto flex md:flex-row-reverse flex-col-reverse box-border h-[600px]'>
            ...
            <div className='md:flex-1 ahh disc1 w-full h-[450px] md:h-full'>
                <img className='scale-[1] top-[-200px] md:top-[-250px]' src={`${baseUrl}woman-keeps-stylus-temple-uses-graphic-tablet-painting-works-with-digital-touch-pad-application-poses-street-downton-against-city-skyscraper-develops-new-design (1).jpg`} />
            </div>
        </motion.div>
        <motion.div
      ref={ref}
        ...
        className='mx-auto flex md:flex-row flex-col-reverse box-border h-[600px]'>
            ...
            <div className='md:flex-1 ehh md:right-[0] w-full h-[350px] md:h-full'>
                <img className='scale-[1.2]' src={`${baseUrl}workers-giving-ideas-new-project.jpg`} alt="disc image" />
            </div>
        </motion.div>

        ...
        <div className='mx-auto flex box-border h-[600px]'>
            <div className='flex-1 flex flex-col w-fit text-left h-full py-20'>
                <div className="mx-auto">
                    ...
                    <p className='text-textGray py-5 text-lg font-light w-[400px]'>Finding visionary leaders who will steer your startup toward success. We identify, vet, and place top-tier executives who align with your company's mission and culture. </p>
                    <button className='bg-secondary w-fit rounded-full h-fit my-auto text-[12px] py-3 text-primary px-8'>Book a call</button>
                </div>
            </div>
            <div className='flex-1 disc w-full h-full'>
                <img className='' src="Images/african-american-business-man-reading-news-talking-phone.jpg" alt="disc image" />
            </div>
        </div>

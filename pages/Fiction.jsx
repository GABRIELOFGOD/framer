    ...
    <div>
      <div className='flex overflow-hidden relative bg-dark text-primary gap-10 py-24 px-52'>
        ...
        <div className="flex-1 show">
          ...
          <p className='w-[480px] pb-5 text-lg font-light'>Revlab's fraction talents market plane marketplace is the new secret weapon</p>
          <button className='bg-secondary rounded-full h-fit my-auto text-[14px] py-4 text-primary px-8'>Find your next Executive</button>
        </div>

      ...
      <div className='w-full pb-2 md:pb-12 md:pt-28 py-8 px-12 md:px-48'>
        ...
        <div className='md:flex justify-between'>
          <div className='md:text-left mx-auto md:mx-0 text-center'>
            <p className='md:text-textGray text-[12px] md:text-xl w-[240px] md:w-[500px] py-5'>We connect ambitious talent with high growth, VC backed, startups and scale-ups.</p>
